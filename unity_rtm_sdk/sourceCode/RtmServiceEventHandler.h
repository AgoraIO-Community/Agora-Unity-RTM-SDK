...
typedef void(__stdcall* FUNC_onRenewTokenResult)(int handlerId,
                                                 const char* token,
                                                 int errorCode);
typedef void(__stdcall* FUNC_onTokenExpired)(int handlerId);
typedef void(__stdcall* FUNC_onLogout)(int handlerId, int errorCode);
typedef void(__stdcall* FUNC_onConnectionStateChanged)(int handlerId,
                                                       int state,
                                                       int reason);
typedef void(__stdcall* FUNC_onSendMessageResult)(int handlerId,
                                                  long long messageId,
                                                  int errorCode);
typedef void(__stdcall* FUNC_onMessageReceivedFromPeer)(int handlerId,
                                                        const char* peerId,
                                                        void* message);
typedef void(__stdcall* FUNC_onImageMessageReceivedFromPeer)(int handlerId,
                                                             const char* peerId,
                                                             void* message);
typedef void(__stdcall* FUNC_onFileMessageReceivedFromPeer)(int handlerId,
                                                            const char* peerId,
                                                            void* message);
typedef void(__stdcall* FUNC_onMediaUploadingProgress)(int handlerId,
                                                       long long requestId,
                                                       long long totalSize,
                                                       long long currentSize);
typedef void(__stdcall* FUNC_onMediaDownloadingProgress)(int handlerId,
                                                         long long requestId,
                                                         long long totalSize,
                                                         long long currentSize);
typedef void(__stdcall* FUNC_onFileMediaUploadResult)(int handlerId,
                                                      long long requestId,
                                                      void* fileMessage,
                                                      int code);
typedef void(__stdcall* FUNC_onImageMediaUploadResult)(int handlerId,
                                                       long long requestId,
                                                       void* imageMessage,
                                                       int code);
typedef void(__stdcall* FUNC_onMediaDownloadToFileResult)(int handlerId,
                                                          long long requestId,
                                                          int code);
typedef void(__stdcall* FUNC_onMediaDownloadToMemoryResult)(int handlerId,
                                                            long long requestId,
                                                            const char* memory,
                                                            long long length,
                                                            int code);
typedef void(__stdcall* FUNC_onMediaCancelResult)(int handlerId,
                                                  long long requestId,
                                                  int code);
typedef void(__stdcall* FUNC_onQueryPeersOnlineStatusResult)(
    int handlerId,
    long long requestId,
    void* peersStatus,
    int peerCount,
    int errorCode);
typedef void(__stdcall* FUNC_onSubscriptionRequestResult)(int handlerId,
                                                          long long requestId,
                                                          int errorCode);
typedef void(__stdcall* FUNC_onQueryPeersBySubscriptionOptionResult)(
    int handlerId,
    long long requestId,
    const char* peerIds[],
    int peerCount,
    int errorCode);
typedef void(__stdcall* FUNC_onPeersOnlineStatusChanged)(int handlerId,
                                                         void* peersStatus,
                                                         int peerCount);
typedef void(__stdcall* FUNC_onSetLocalUserAttributesResult)(
    int handlerId,
    long long requestId,
    int errorCode);
typedef void(__stdcall* FUNC_onDeleteLocalUserAttributesResult)(
    int handlerId,
    long long requestId,
    int errorCode);
typedef void(__stdcall* FUNC_onClearLocalUserAttributesResult)(
    int handlerId,
    long long requestId,
    int errorCode);
typedef void(__stdcall* FUNC_onGetUserAttributesResult)(int handlerId,
                                                        long long requestId,
                                                        const char* userId,
                                                        void* attributes,
                                                        int numberOfAttributes,
                                                        int errorCode);
typedef void(__stdcall* FUNC_onSetChannelAttributesResult)(int handlerId,
                                                           long long requestId,
                                                           int errorCode);
typedef void(__stdcall* FUNC_onAddOrUpdateLocalUserAttributesResult)(
    int handlerId,
    long long requestId,
    int errorCode);
typedef void(__stdcall* FUNC_onDeleteChannelAttributesResult)(
    int handlerId,
    long long requestId,
    int errorCode);
typedef void(__stdcall* FUNC_onClearChannelAttributesResult)(
    int handlerId,
    long long requestId,
    int errorCode);
typedef void(__stdcall* FUNC_onGetChannelAttributesResult)(
    int handlerId,
    long long requestId,
    const char* attributes,
    int numberOfAttributes,
    int errorCode);
typedef void(__stdcall* FUNC_onGetChannelMemberCountResult)(
    int handlerId,
    long long requestId,
...
typedef void (*FUNC_onRenewTokenResult)(int handlerId,
                                        const char* token,
                                        int errorCode);
typedef void (*FUNC_onTokenExpired)(int handlerId);
typedef void (*FUNC_onLogout)(int handlerId, int errorCode);
typedef void (*FUNC_onConnectionStateChanged)(int handlerId,
                                              int state,
                                              int reason);
typedef void (*FUNC_onSendMessageResult)(int handlerId,
                                         long long messageId,
                                         int errorCode);
typedef void (*FUNC_onMessageReceivedFromPeer)(int handlerId,
                                               const char* peerId,
                                               void* message);
typedef void (*FUNC_onImageMessageReceivedFromPeer)(int handlerId,
                                                    const char* peerId,
                                                    void* message);
typedef void (*FUNC_onFileMessageReceivedFromPeer)(int handlerId,
                                                   const char* peerId,
                                                   void* message);
typedef void (*FUNC_onMediaUploadingProgress)(int handlerId,
                                              long long requestId,
                                              long long totalSize,
                                              long long currentSize);
typedef void (*FUNC_onMediaDownloadingProgress)(int handlerId,
                                                long long requestId,
                                                long long totalSize,
                                                long long currentSize);
typedef void (*FUNC_onFileMediaUploadResult)(int handlerId,
                                             long long requestId,
                                             void* fileMessage,
                                             int code);
typedef void (*FUNC_onImageMediaUploadResult)(int handlerId,
                                              long long requestId,
                                              void* imageMessage,
                                              int code);
typedef void (*FUNC_onMediaDownloadToFileResult)(int handlerId,
                                                 long long requestId,
                                                 int code);
typedef void (*FUNC_onMediaDownloadToMemoryResult)(int handlerId,
                                                   long long requestId,
                                                   const char* memory,
                                                   long long length,
                                                   int code);
typedef void (*FUNC_onMediaCancelResult)(int handlerId,
                                         long long requestId,
                                         int code);
typedef void (*FUNC_onQueryPeersOnlineStatusResult)(int handlerId,
                                                    long long requestId,
                                                    void* peersStatus,
                                                    int peerCount,
                                                    int errorCode);
typedef void (*FUNC_onSubscriptionRequestResult)(int handlerId,
                                                 long long requestId,
                                                 int errorCode);
typedef void (*FUNC_onQueryPeersBySubscriptionOptionResult)(
    int handlerId,
    long long requestId,
    const char* peerIds[],
    int peerCount,
    int errorCode);
typedef void (*FUNC_onPeersOnlineStatusChanged)(int handlerId,
                                                const char* peersStatus,
                                                int peerCount);
typedef void (*FUNC_onSetLocalUserAttributesResult)(int handlerId,
                                                    long long requestId,
                                                    int errorCode);
typedef void (*FUNC_onDeleteLocalUserAttributesResult)(int handlerId,
                                                       long long requestId,
                                                       int errorCode);
typedef void (*FUNC_onClearLocalUserAttributesResult)(int handlerId,
                                                      long long requestId,
                                                      int errorCode);
typedef void (*FUNC_onGetUserAttributesResult)(int handlerId,
                                               long long requestId,
                                               const char* userId,
                                               const char* attribute,
                                               int numberOfAttributes,
                                               int errorCode);
typedef void (*FUNC_onSetChannelAttributesResult)(int handlerId,
                                                  long long requestId,
                                                  int errorCode);
typedef void (*FUNC_onAddOrUpdateLocalUserAttributesResult)(int handlerId,
                                                            long long requestId,
                                                            int errorCode);
typedef void (*FUNC_onDeleteChannelAttributesResult)(int handlerId,
                                                     long long requestId,
                                                     int errorCode);
typedef void (*FUNC_onClearChannelAttributesResult)(int handlerId,
                                                    long long requestId,
                                                    int errorCode);
typedef void (*FUNC_onGetChannelAttributesResult)(int handlerId,
                                                  long long requestId,
                                                  const char* attributes,
                                                  int numberOfAttributes,
                                                  int errorCode);
typedef void (*FUNC_onGetChannelMemberCountResult)(int handlerId,
                                                   long long requestId,
                                                   void* channelMemberCounts,
                                                   int channelCount,
                                                   int errorCode);
