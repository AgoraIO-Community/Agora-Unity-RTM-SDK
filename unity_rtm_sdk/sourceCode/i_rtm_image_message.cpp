...
extern "C" {
#define IMAGE_MESSAGE_INSTANCE \
  static_cast<agora::rtm::IImageMessage*>(image_message_instance)
}
...
*/
AGORA_API void iImage_message_setWidth(void* image_message_instance,
                                       int width) {
