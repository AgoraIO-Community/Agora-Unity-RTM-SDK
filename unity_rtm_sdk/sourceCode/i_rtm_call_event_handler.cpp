...
extern "C" {
#define RTM_CALL_EVENT_HANDLER_PTR \
  static_cast<agora::unity::RtmCallEventHandler*>(eventHandlerPtr);
}

AGORA_API void* i_rtm_call_event_handler_createEventHandler(
    int _index,
    agora::unity::FUNC_onLocalInvitationReceivedByPeer
        _onLocalInvitationReceivedByPeer,
  ...
  return new agora::unity::RtmCallEventHandler(
      _index, _onLocalInvitationReceivedByPeer, _onLocalInvitationCanceled,
      _onLocalInvitationFailure, _onLocalInvitationAccepted,
      _onLocalInvitationRefused, _onRemoteInvitationRefused,
      _onRemoteInvitationAccepted, _onRemoteInvitationReceived,
      _onRemoteInvitationFailure, _onRemoteInvitationCanceled);
}
