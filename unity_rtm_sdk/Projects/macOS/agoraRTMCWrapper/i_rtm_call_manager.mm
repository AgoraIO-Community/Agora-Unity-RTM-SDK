...
#define RTM_CALL_MANAGER_INSTANCE     static_cast<agora::rtm::IRtmCallManager *>(callManagerInstance)

#define I_LOCAL_CALL_INVITATION_PTR static_cast<agora::rtm::ILocalCallInvitation *>(invitation)

#define I_REMOTE_CALL_INVITATION_PTR    static_cast<agora::rtm::IRemoteCallInvitation *>(invitation)
}

AGORA_API int rtm_call_manager_sendLocalInvitation(void *callManagerInstance, void *invitation)
{
    return RTM_CALL_MANAGER_INSTANCE->sendLocalInvitation(I_LOCAL_CALL_INVITATION_PTR);
}


AGORA_API int rtm_call_manager_acceptRemoteInvitation(void *callManagerInstance, void *invitation)
{
    return RTM_CALL_MANAGER_INSTANCE->acceptRemoteInvitation(I_REMOTE_CALL_INVITATION_PTR);
}

AGORA_API int rtm_call_manager_refuseRemoteInvitation(void *callManagerInstance, void *invitation)
{
    return RTM_CALL_MANAGER_INSTANCE->refuseRemoteInvitation(I_REMOTE_CALL_INVITATION_PTR);
}

AGORA_API int rtm_call_manager_cancelLocalInvitation(void *callManagerInstance, void *invitation)
{
    return RTM_CALL_MANAGER_INSTANCE->cancelLocalInvitation(I_LOCAL_CALL_INVITATION_PTR);
}
