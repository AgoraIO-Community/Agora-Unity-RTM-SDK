...
namespace agora_rtm {
    public sealed class RtmClient : IRtmApiNative, IDisposable {
        ...
        public int SendMessageToPeer(string peerId, IMessage message, SendMessageOptions options) {
            ...
            return sendMessageToPeer(_rtmServicePtr, peerId, message.GetPtr(), options.enableOfflineMessaging, options.enableHistoricalMessaging);
        }
        ...
        public int SubscribePeersOnlineStatus(string [] peerIds, Int64 requestId) {
            ...
            return subscribePeersOnlineStatus(_rtmServicePtr, peerIds, peerIds.Length, requestId);
        }
        ...
        public int UnsubscribePeersOnlineStatus(string [] peerIds, Int64 requestId) {
            ...
            return unsubscribePeersOnlineStatus(_rtmServicePtr, peerIds, peerIds.Length, requestId);
        }
        ...
        public int SetChannelAttributes(string channelId, RtmChannelAttribute [] attributes, ChannelAttributeOptions options, Int64 requestId)
        {
            ...
            if (attributes != null && attributes.Length > 0) {
                ...
                return setChannelAttributes(_rtmServicePtr, channelId, attributeLists, attributes.Length, options.enableNotificationToChannelMembers, requestId);
            }
            return -7;
        } 
