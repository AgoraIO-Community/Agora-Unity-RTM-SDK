...
/**
   ...
   */
    virtual void onLocalInvitationReceivedByPeer(agora::rtm:: ILocalCallInvitation *localInvitation) override;
  ...
  /**
   ...
   @param localInvitation An ILocalCallInvitation object.
   */
    virtual void onLocalInvitationCanceled(agora::rtm::ILocalCallInvitation *localInvitation) override;
   ...
   */
    virtual void onLocalInvitationFailure(agora::rtm::ILocalCallInvitation *localInvitation, agora::rtm::LOCAL_INVITATION_ERR_CODE errorCode) override;
   ...
   */
    virtual void onLocalInvitationAccepted(agora::rtm::ILocalCallInvitation *localInvitation, const char *response) override;
  ...
  /**
   ...
   @param response The callee's response to the call invitation.
   */
    virtual void onLocalInvitationRefused(agora::rtm::ILocalCallInvitation *localInvitation, const char *response) override;
   ...
   */
    virtual void onRemoteInvitationRefused(agora::rtm::IRemoteCallInvitation *remoteInvitation) override;
  ...
  /**
   ...
   @param remoteInvitation An IRemoteCallInvitation object.
   */
    virtual void onRemoteInvitationAccepted(agora::rtm::IRemoteCallInvitation *remoteInvitation) override;
  ...
  /**
   ...
   @param remoteInvitation An IRemoteCallInvitation object.
   */
    virtual void onRemoteInvitationReceived(agora::rtm::IRemoteCallInvitation *remoteInvitation) override;
   ...
   */
    virtual void onRemoteInvitationFailure(agora::rtm::IRemoteCallInvitation *remoteInvitation, agora::rtm::REMOTE_INVITATION_ERR_CODE errorCode) override;
  ...
  /**
   ...
   @param remoteInvitation An IRemoteCallInvitation object.
   */
    virtual void onRemoteInvitationCanceled(agora::rtm::IRemoteCallInvitation *remoteInvitation) override;
};
}
}
